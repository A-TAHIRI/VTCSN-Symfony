...
class RideRepository extends ServiceEntityRepository
{
   ...
   //Pour recuperer les trajets d'un utilisateur
    public function findTrajetsByUser( $user): array
    {
   ...
   //Pour récupérer les trajets du chauffeur
    public function findTrajetsByDriver(Driver $driver)
    {
        $query = $this->createQueryBuilder('r')
